...
CREATE UNIQUE INDEX IF NOT EXISTS "IDX_a50fac903ff5f90d82f21d769e" ON "public"."document_version" ("document_id", "document_version");
...
CREATE TABLE IF NOT EXISTS "public"."query_version" (
...
CREATE UNIQUE INDEX IF NOT EXISTS "IDX_ce90264a17e7f26b5e60828c5e" ON "public"."query_version" ("query_id", "query_version");

CREATE TABLE IF NOT EXISTS "public"."judgement_pair" (
...
CREATE INDEX IF NOT EXISTS "IDX_0413dd612cce83f587b8974c0f" ON "public"."judgement_pair" ("document_id", "query_id");

CREATE INDEX IF NOT EXISTS "IDX_1b1d70926e58a51849289436e5" ON "public"."judgement_pair" ("priority");

CREATE INDEX IF NOT EXISTS "IDX_c5db286d4cf85dc1f1cce545ae" ON "public"."judgement_pair" ("query_id");

CREATE INDEX IF NOT EXISTS "IDX_fc9335e72b0b3d352840b4bc45" ON "public"."judgement_pair" ("document_id");

CREATE TABLE IF NOT EXISTS "public"."judgement" (
  "id" serial,
...
CREATE INDEX IF NOT EXISTS "IDX_c54b24c6f4ae078b0f289b2d6b" ON "public"."judgement" ("query_query", "query_version");

CREATE INDEX IF NOT EXISTS "IDX_c7a3c0c8dd85fc22c05fb59f2b" ON "public"."judgement" ("document_document", "document_version");
...
CREATE INDEX IF NOT EXISTS "IDX_121c67d42dd543cca0809f5990" ON "public"."feedback" ("user_id");